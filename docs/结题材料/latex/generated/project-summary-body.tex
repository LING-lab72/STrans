...
\endlastfoot
后端 Python & 56/56 & 通过 \\
前端 JavaScript & 16/16 & 通过 \\
项目内道路建模桥接 & 6/6 & 通过 \\
主项目自动化 & 78/78 & 通过 \\
道路建模原工具 Python & 17/17 & 通过 \\
道路建模原工具 Node 脚本组 & 5/5 & 通过 \\
全部测试/脚本单元 & 100/100 & 通过 \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={真实沙盘代表识别结果}]{assets/selected-contact-sheet.jpg}}
